...
public abstract class EndlessProgressableRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
	...
	public EndlessProgressableRecyclerViewScrollListener(LinearLayoutManager layoutManager) {
		init();
		this.mLayoutManager = layoutManager;
	}
	
	public EndlessProgressableRecyclerViewScrollListener(GridLayoutManager layoutManager) {
		init();
		this.mLayoutManager = layoutManager;
		visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
	}
	
	public EndlessProgressableRecyclerViewScrollListener(StaggeredGridLayoutManager layoutManager) {
		init();
		this.mLayoutManager = layoutManager;
		visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
	}
